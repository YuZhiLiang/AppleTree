...
public class RadarView extends View {
    ...
    private int mainColor = 0xFF46B29E;//雷达区颜色
    private int valueColor = 0xFF46B29E;//数据区颜色
    private int textColor = 0xFF46B29E;//文本颜色

    private float mainLineWidth = 0.5f;//雷达网线宽度dp
    private float valueLineWidth = 1f;//数据区边宽度dp
    private float valuePointRadius = 0f;//数据区圆点半径dp
